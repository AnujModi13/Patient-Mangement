...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        // Database instances with valid PostgreSQL database names (using underscores)
        DatabaseInstance authServiceDb =
                createDatabase("AuthServiceDB", "auth_service_db");

        DatabaseInstance patientServiceDb =
                createDatabase("PatientServiceDB", "patient_service_db");
    ...
    private FargateService createFargateService(String id,
        ...
        if (db != null) {
            envVars.put("SPRING_DATASOURCE_URL", "jdbc:postgresql://%s:%s/%s".formatted(
                    ...
                    db.getSecret().secretValueFromJson("dbname").toString()
            ));
    ...
    public static void main(final String[] args) {
        ...
        app.synth();
        System.out.println("App synthesizing complete.");
    }
}